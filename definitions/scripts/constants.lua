...
-- 	return FESTIVAL_EVENT_INFO[WORLD_FESTIVAL_EVENT] ~= nil and FESTIVAL_EVENT_INFO[WORLD_FESTIVAL_EVENT].SERVER_NAME
-- 		or ""
-- end
...
-- 	else
-- 		return FESTIVAL_EVENT_INFO[festival] ~= nil
-- 				and (string.format("%s_s%d", FESTIVAL_EVENT_INFO[festival].SERVER_NAME, season))
-- 			or ""
-- 	end
-- end
...
-- FE_MUSIC = (FESTIVAL_EVENT_MUSIC[WORLD_FESTIVAL_EVENT] ~= nil and FESTIVAL_EVENT_MUSIC[WORLD_FESTIVAL_EVENT].sound)
-- 	or (SPECIAL_EVENT_MUSIC[WORLD_SPECIAL_EVENT] ~= nil and SPECIAL_EVENT_MUSIC[WORLD_SPECIAL_EVENT].sound)
-- 	or "dontstarve/music/music_FE_wickerbottom"
...
-- 		str = "MADSCIENCE",
-- 		sort = 100,
-- 		icon = "tab_madscience_lab.tex",
-- 		crafting_station = true,
-- 		manufacturing_station = true,
-- 	},
-- 	CARNIVAL_PRIZESHOP = {
-- 		str = "CARNIVAL_PRIZESHOP",
-- 		sort = 100,
...
-- 	WINTERSFEASTCOOKING = {
-- 		str = "WINTERSFEASTCOOKING",
-- 		sort = 100,
-- 		icon = "tab_feast_oven.tex",
-- 		crafting_station = true,
-- 	},
-- 	HERMITCRABSHOP = {
-- 		str = "HERMITCRABSHOP",
-- 		sort = 100,
-- 		icon = "tab_hermitcrab_shop.tex",
-- 		crafting_station = true,
-- 		shop = true,
-- 	},
-- 	TURFCRAFTING = {
...
-- 		str = "BATTLESONGS",
-- 		sort = 999,
-- 		icon = "tab_battlesongs.tex",
-- 		owner_tag = "battlesinger",
-- 		icon_atlas = "images/hud2.xml",
-- 	},
-- 	SPIDERCRAFT = {
-- 		str = "SPIDERCRAFT",
-- 		sort = 999,
-- 		icon = "tab_spidercraft.tex",
...
-- 		str = "BALLOONOMANCY",
-- 		sort = 999,
-- 		icon = "tab_balloonomancy.tex",
-- 		owner_tag = "balloonomancer",
-- 		icon_atlas = "images/hud2.xml",
-- 	},
-- 	CLOCKMAKER = {
-- 		str = "CLOCKMAKER",
-- 		sort = 999,
-- 		icon = "tab_clockmaker.tex",
-- 		owner_tag = "clockmaker",
-- 		icon_atlas = "images/hud2.xml",
-- 	},
-- 	STRONGMAN = {
-- 		str = "STRONGMAN",
-- 		sort = 999,
-- 		icon = "tab_strongman.tex",
-- 		owner_tag = "strongman",
-- 		icon_atlas = "images/hud2.xml",
-- 	},
-- }
...
-- 		str = "QUAGMIRE_MEALINGSTONE",
-- 		sort = 0,
-- 		icon = "tab_quagmire_mealingstone.tex",
-- 		icon_atlas = "images/quagmire_hud.xml",
-- 		crafting_station = true,
-- 	},
-- 	QUAGMIRE_TRADER_ELDER = {
-- 		str = "QUAGMIRE_TRADER_ELDER",
-- 		sort = 0,
...
-- 		shop = true,
-- 	},
-- 	QUAGMIRE_TRADER_MERM1 = {
-- 		str = "QUAGMIRE_TRADER_MERM1",
-- 		sort = 0,
-- 		icon = "tab_quagmire_trader_merm1.tex",
-- 		icon_atlas = "images/quagmire_hud.xml",
-- 		crafting_station = true,
-- 		shop = true,
-- 	},
-- 	QUAGMIRE_TRADER_MERM2 = {
-- 		str = "QUAGMIRE_TRADER_MERM2",
-- 		sort = 0,
-- 		icon = "tab_quagmire_trader_merm2.tex",
-- 		icon_atlas = "images/quagmire_hud.xml",
-- 		crafting_station = true,
-- 		shop = true,
-- 	},
-- 	QUAGMIRE_TRADER_MUM = {
-- 		str = "QUAGMIRE_TRADER_MUM",
-- 		sort = 0,
-- 		icon = "tab_quagmire_trader_mum.tex",
-- 		icon_atlas = "images/quagmire_hud.xml",
-- 		crafting_station = true,
-- 		shop = true,
-- 	},
-- 	QUAGMIRE_TRADER_KID = {
-- 		str = "QUAGMIRE_TRADER_KID",
-- 		sort = 0,
-- 		icon = "tab_quagmire_trader_kid.tex",
-- 		icon_atlas = "images/quagmire_hud.xml",
-- 		crafting_station = true,
-- 		shop = true,
-- 	},
...
-- GREY = { 0.57, 0.57, 0.57, 1 }
-- BLACK = { 0.1, 0.1, 0.1, 1 }
-- WHITE = { 1, 1, 1, 1 }
-- BROWN = { 97 / 255, 73 / 255, 46 / 255, 255 / 255 }
-- RED = { 0.7, 0.1, 0.1, 1 }
-- DARKGREY = { 0.12, 0.12, 0.12, 1 }
